Imports WidLoggerV2Comms.SerDev_LoggerV2_ComFuncs
...
Public Class SerComms
    ...
    Public ReadOnly Property DevVersion As String
        Get
            Return CType(ParentFrm, frmMain).connectedDevVersion
        End Get
    End Property
    ...
    Public Function Ser_SendCmd(ByVal CMD_Byte As CMD_ByteID, ByRef ParamList() As Object, ByRef RetVals() As Object) As MyErr_Enum
        ...
        Try
            ...
            Ser.BaudRate = Ser_Baud
            Ser.Open()
            Ser.ReadTimeout = Ser_Timeout
            Ser.WriteTimeout = Ser_Timeout
...
WasErr:
    ...
    Public Function VersionStringToInteger(verStr As String) As Integer
        Return CType(ParentFrm, frmMain).VersionStringToInteger(verStr)
        'Dim subVerStrs() As String
        'Dim retVal As Integer = 0
        'verStr = verStr.Trim
        'If verStr.StartsWith("V") Then
        '    subVerStrs = verStr.Split(".")
...
Public Class BaudRateConfig
    Public BaudRate As UInt32
    Public bsel As Int16
    Public bscale As SByte

    Public Enum BaudRateConfigIDs
        Baud_115200 = 0
        Baud_460800 = 1
        Baud_921600 = 2
    End Enum

    'AT 32MHz clock frequency!!!
    Public Shared BaudRateConfigs As New List(Of BaudRateConfig) From {New BaudRateConfig(115200, 524, -5),
                                                                       New BaudRateConfig(460800, 107, -5),
                                                                       New BaudRateConfig(921600, 75, -6)}

    Public Sub New()

    End Sub

    Public Sub New(_BaudRate As UInt32, _bsel As Int16, _bscale As SByte)
        BaudRate = _BaudRate
        bsel = _bsel
        bscale = _bscale
    End Sub
