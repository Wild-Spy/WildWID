...
Public Class SerDev_LoggerV2_ComFuncs
    ...
    Enum CMD_ByteID As Byte
        ...
        Get_RFParams = &H23
        Set_RFParams = &H24
        Get_LoggerGroupId = &H25
        Set_LoggerGroupId = &H26
        Get_LoggerId = &H27
        Get_WarningSignalDuration = &H28
        Set_WarningSignalDuration = &H29
        Get_InterLogRFParams = &H30
        Set_InterLogRFParams = &H31
        Get_LoggerTable = &H32
        Get_IridiumMonthNextReset = &H33
        Set_IridiumMonthNextReset = &H34
        Get_MonthByteLimit = &H35
        Set_MonthByteLimit = &H36
    ...
    Private Sub InitCmdTable()
        ...
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_LoggerGroupId, AddressOf Ser_CMD_Get_LoggerGroupId))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Set_LoggerGroupId, AddressOf Ser_CMD_Set_LoggerGroupId))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_LoggerId, AddressOf Ser_CMD_Get_LoggerId))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_WarningSignalDuration, AddressOf Ser_CMD_Get_WarningSignalDuration))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Set_WarningSignalDuration, AddressOf Ser_CMD_Set_WarningSignalDuration))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_InterLogRFParams, AddressOf Ser_CMD_Get_InterLogRFParams))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Set_InterLogRFParams, AddressOf Ser_CMD_Set_InterLogRFParams))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_LoggerTable, AddressOf Ser_CMD_Get_LoggerTable))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_IridiumMonthNextReset, AddressOf Ser_CMD_Get_IridiumMonthNextReset))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Set_IridiumMonthNextReset, AddressOf Ser_CMD_Set_IridiumMonthNextReset))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Get_MonthByteLimit, AddressOf Ser_CMD_Get_MonthByteLimit))
        CmdAry.Add(New Ser_CMD(CMD_ByteID.Set_MonthByteLimit, AddressOf Ser_CMD_Set_MonthByteLimit))
    End Sub
    ...
    Private Function Ser_CMD_Get_AllRecordsFast(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        ...
        Dim tmpBufActivity As New List(Of Single)
        Dim tmpBufLoggerShortId As New List(Of Byte)
        ...
        Dim includeActivity As Boolean = False
        Dim includeLoggerShortId As Boolean = False
        ...
        Try
            If SerComParent.VersionStringToInteger(SerComParent.DevVersion) >= SerComParent.VersionStringToInteger("V2.3.1") Then
                includeRSSI = True
                includeActivity = True
                includeLoggerShortId = True
                RECORD_LEN = 13 'compressed len is 12 but flags are tx'd as a seperate byte so len here is 12 (added 'activity' byte per record)
                SortPreceedingData = True
            ElseIf SerComParent.VersionStringToInteger(SerComParent.DevVersion) >= SerComParent.VersionStringToInteger("V2.3.0") Then
                includeRSSI = True
                includeActivity = True
                RECORD_LEN = 12 'compressed len is 11 but flags are tx'd as a seperate byte so len here is 12 (added 'activity' byte per record)
                SortPreceedingData = True
            ElseIf SerComParent.VersionStringToInteger(SerComParent.DevVersion) >= SerComParent.VersionStringToInteger("V2.1.1") Then
                includeRSSI = True
        ...
        While (recCount < recordCount)
            ...
            For i = 0 To recPerGrp - 1
                ...
                End If
                If includeActivity Then
                    tmpBufActivity.Add(Math.Round(CSng(tmpBytes(12)) / CSng(255) * 100.0, 2))
                End If
                If includeLoggerShortId Then
                    tmpBufLoggerShortId.Add(tmpBytes(13))
                End If
        ...
        RetVals(4) = tmpBufActivity
        RetVals(5) = tmpBufLoggerShortId
...
WasErrLbl:
    ...
    Private Function Ser_CMD_Cmd_EraseDataflash(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        ...
        SerComParent.Ser_Timeout = 180000
    ...
    Private Function Ser_CMD_Get_LoggerGroupId(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(2) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Set_LoggerGroupId(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(2) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Get_LoggerId(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(4) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Get_WarningSignalDuration(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(2) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Set_WarningSignalDuration(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(2) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Get_InterLogRFParams(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(39) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Set_InterLogRFParams(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(39) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Get_LoggerTable(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpErr As MyErr_Enum
        Dim tmpBuf1(0) As Byte

        tmpErr = SerComParent.Ser_TxSeg(SerComParent.Ser_Timeout, tmpBuf1, 1)
        If tmpErr < 0 Then Return tmpErr

        Dim len As Byte = tmpBuf1(0)

        Dim retAry As HashSet(Of String) = New HashSet(Of String)

        Dim tmpBuf(3) As Byte
        For i = 0 To len - 1
            tmpErr = SerComParent.Ser_TxSeg(SerComParent.Ser_Timeout, tmpBuf, 4)
            If tmpErr < 0 Then Return tmpErr
            retAry.Add(Convert.ToString(BitConverter.ToUInt32(tmpBuf, 0), 16).ToUpper())
        Next
    ...
    Private Function Ser_CMD_Get_IridiumMonthNextReset(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(5) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Set_IridiumMonthNextReset(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(5) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Get_MonthByteLimit(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(2) As Byte
        Dim tmpErr As MyErr_Enum
    ...
    Private Function Ser_CMD_Set_MonthByteLimit(ByRef ParamLst() As Object, ByRef RetVals() As Object) As MyErr_Enum
        Dim tmpBuf(2) As Byte
        Dim tmpErr As MyErr_Enum
