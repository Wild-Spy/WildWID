...
//#define INTER_LOGGER_CC110L_DISABLE //puts the CC110L to sleep so that it can't rx regardless if it's being used for inter-logger comms or just 433MHz pickups
#define CC2500_DISABLE //puts the CC2500 to sleep so that it can't rx (saves power too)
