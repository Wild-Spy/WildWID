...
void SettingsManager_LoadAllSettings() {
	...
	if (setting_WarningSignalDuration == 0xFFFF) setting_WarningSignalDuration = 0;
	SettingFromEEPROM(MONTHBYTESSENT);
	if (setting_IridiumBytesSentThisMonth == 0xFFFFFFFFL) setting_IridiumBytesSentThisMonth = 0;
	SettingFromEEPROM(MONTHBYTELIMIT);
	if (setting_IridiumMonthlyByteLimit == 0xFFFFFFFFL) setting_IridiumMonthlyByteLimit = 30*1024;
	SettingFromEEPROM(IRIDIUMLOGSSENT);
	if (setting_LogsSentViaIridium == 0xFFFFFFFFL) setting_LogsSentViaIridium = 0;
