...
typedef enum _GM862_err_t {
	err_9602_SuccessAndUDTime	=  1,
	err_9602_Success			=  0,
	err_9602_Timeout			= -1,
	err_9602_USBUnplugged		= -2,
	err_9602_InvalidData		= -3,
	err_9602_BadResponse		= -5,
	err_9602_TimeNotUpdated		= -6,
	err_9602_Unknown			= -20
} GM862_err_t;
...
#define GM862_SendGeneralCmd_P(cmdstrP)								GM862_SendCmdAndCheck_P(cmdstrP, PSTR_IRIDIUM_RESPONSE_OK, 3000)
#define GM862_SendGeneralCmd_ret_P(cmdstrP, retVal)					(retVal = GM862_SendCmdAndCheck_P(cmdstrP, PSTR_IRIDIUM_RESPONSE_OK, 3000))
...
GM862_err_t GM862_SendCmdAndCheck_P(const char* cmdstrP, const char* expectedResponseP, uint16_t timeout);
