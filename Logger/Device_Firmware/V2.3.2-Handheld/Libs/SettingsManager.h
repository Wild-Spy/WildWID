...
#define IRIDIUMMONTHNXTRST_ADD		INTERLOGRFPARAMS_ADD+INTERLOGRFPARAMS_SIZE
//#define IRIDIUMMONTHNXTRST_ADD		IRIDIUMMONTHSTART_ADD+IRIDIUMMONTHSTART_SIZE
...
#define IRIDIUMMONTHNXTRST_VAR		setting_IridiumMonthNextReset	//RTC_Time_t setting_IridiumMonthNextReset;
#define IRIDIUMMONTHNXTRST_TYPE		(uint8_t*)&//(RTC_Time_t*)&
#define IRIDIUMMONTHNXTRST_SIZE		6
