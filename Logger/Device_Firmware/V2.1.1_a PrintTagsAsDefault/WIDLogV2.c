...
uint8_t TagDispMode = 3;				//!<How tags are displayed (None (1), show ID only (2), ID and date/time or ID(3), Date/Time and Address(4))
...
// 		_delay_ms(2);
	...
	//#define BBAK_LOW_VOLTAGE_LEVEL	3.5
	//CheckBatVolt++;
	//if (CheckBatVolt >= BATVOLTCHECK) {
		//CheckBatVolt = 0;
		//tmpBatV = CheckBatteryVoltage();
		//if (tmpBatV < BBAK_LOW_VOLTAGE_LEVEL) {	
			////Low battery!
