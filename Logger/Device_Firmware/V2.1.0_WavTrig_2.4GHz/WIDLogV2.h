...
#include "Strings.h"
#include "Libs/MX_WavTrig.h"
#include "Libs/RndGen.h"
#include "Libs/RndTrackPlayer.h"
...
#define FLASHRECORD_SIZE					10 //9	//size of a record in bytes
...
#define SAVE_SYS_MSG(CMD, DATA)		RecordToFlash(&RTC_c_Time, CMD + (DATA), 0x02, 0x00)
...
uint8_t loadRecord(uint32_t, RTC_Time_t*, uint32_t*, uint8_t*);
