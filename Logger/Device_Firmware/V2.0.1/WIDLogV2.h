...
#define LOGGINGISENABLED			(LoggingEnabled > 1)
...
#define SAVE_SYS_MSG(CMD, DATA)		RecordToFlash(&RTC_c_Time, CMD + (DATA), 0x02)
...
uint8_t loadRecord(uint32_t, RTC_Time_t*, uint32_t*);
